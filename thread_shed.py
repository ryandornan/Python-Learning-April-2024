...
6.
Now, iterate through daily_transactions (remember, this is a list of strings currently), and for each transaction, 
...
7.
Print daily_transactions_split.How’s it looking?
